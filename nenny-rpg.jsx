...
export default function NennyRPG() {
  ...
  const [screen, setScreen]   = useState(state.username?"main":"register"); // register|main|leaderboard|friends|profile|battle|loot
  ...
  const [viewProfile, setViewProfile] = useState(null); // external profile

  // persist + push profile on state change
  useEffect(() => {
    saveLocal(state);
      ...
      <div style={{maxWidth:480,margin:"0 auto",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:10}}>
          ...
          <div style={{textAlign:"right"}}>
            ...
            {inbox.length>0&&<div style={{fontSize:10,color:"#f59e0b",animation:"pulse 2s infinite"}}>🎁 {inbox.length} gift!</div>}
          </div>
        </div>
        ...
        {tab==="daily"&&(
          <div style={{animation:"slideIn 0.3s ease"}}>
            ...
            <div className="card" style={{marginBottom:10,background:"rgba(245,158,11,0.04)",border:"1px solid #f59e0b15"}}>
              ...
              <div style={{fontSize:10,color:"#666",lineHeight:1.5}}>Ogni video oltre i 100 diventa un gettone extra. Accumulane abbastanza per sfidare i boss settimanali e ottenere loot Epico/Leggendario!</div>
            </div>
      ...
      <div style={{maxWidth:480,margin:"0 auto",position:"relative",zIndex:1}}>
        ...
        {socialTab==="leaderboard"&&(
          <div style={{animation:"slideIn 0.3s ease"}}>
            ...
            {leaderboard.map((p,i)=>(
              <div key={p.username} className="card" style={{
                marginBottom:6,
                ...
                <div style={{display:"flex",alignItems:"center",gap:10}}>
                  ...
                  <div style={{flex:1}}>
                    <div style={{fontSize:13,fontWeight:700,color:p.username===state.username?"#fde68a":"#e8e0d0"}}>
                      {p.username} {p.username===state.username&&"(tu)"}
                    </div>
        ...
        {socialTab==="friends"&&(
          <div style={{animation:"slideIn 0.3s ease"}}>
            ...
            {!(state.friends||[]).length
              ? <div style={{textAlign:"center",color:"#444",fontSize:12,padding:20}}>Nessun amico ancora. Aggiungi qualcuno!</div>
